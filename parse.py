...
def parse_args():
    ...
    parser.add_argument('--act', type=str, default='sigmoid', help='the activate function for the DNN')
   # parser.add_argument('--w_dims', type=str, default='[64,128]', help='the dims for the W DNN')
    ...
    parser.add_argument('--noise_scale', type=float, default=1e-2, help='noise scale for noise generating')
    ...
    parser.add_argument('--sampling_steps', type=int, default=1, help='steps of the forward process during inference')
